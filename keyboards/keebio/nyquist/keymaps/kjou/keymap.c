...
[_QWERTY] = LAYOUT( \
  ...
  KC_TAB,      KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
    ...
    _______,     KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_BSPC,  KC_SPC,  RAISE,   KC_LGUI, KC_LALT, KC_LCTL, _______ \
),
...
[_LOWER] = LAYOUT( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, \
    ...
    _______, _______, _______, _______, _______, KC_ENT,  KC_ENT,      _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
